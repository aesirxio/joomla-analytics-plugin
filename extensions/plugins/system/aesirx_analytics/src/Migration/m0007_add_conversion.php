...
$sql[] = "
    CREATE TABLE `#__analytics_conversion` (
...
$sql[] = "
    CREATE TABLE `#__analytics_conversion_item` (
...
$sql[] = "
    ALTER TABLE `#__analytics_conversion`
    ADD CONSTRAINT `#__analytics_conversion_ibfk_1` FOREIGN KEY (`flow_uuid`)
    REFERENCES `#__analytics_flows` (`uuid`) ON DELETE CASCADE ON UPDATE CASCADE;";

// Add foreign key constraint to analytics_conversion_item table
$sql[] = "
    ALTER TABLE `#__analytics_conversion_item`
    ADD CONSTRAINT `#__analytics_conversion_item_ibfk_1` FOREIGN KEY (`conversion_uuid`)
    REFERENCES `#__analytics_conversion` (`uuid`) ON DELETE CASCADE ON UPDATE CASCADE;";
